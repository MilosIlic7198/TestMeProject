...
public class StudentTestFacade {
    ...
    public ArrayList<SubmittedQuestion> returnStudentQuestions(Test test, JPanel question_Panel_) {
        return composeSubmittedQuestion(test);
    }

    public ArrayList<SubmittedTask> returnStudentTasks(Test test, JPanel task_Panel_) {
        return composeSubmittedTask(test);
    }

    private ArrayList<SubmittedQuestion> composeSubmittedQuestion(Test test) {
        ArrayList<SubmittedQuestion> sQList = new ArrayList<>();
    ...
    private ArrayList<SubmittedTask> composeSubmittedTask(Test test) {
        ArrayList<SubmittedTask> sTList = new ArrayList<>();
        SubmittedTask st;
        for (int i = 0; i < arrayOfGeneratedTaskJPanels.length; i++) {
